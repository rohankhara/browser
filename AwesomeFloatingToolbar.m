...

{
        ...
        
    {
        ...
        NSMutableArray *buttonsArray2 = [[NSMutableArray alloc] init];
            ...
            
        {
            ...
            // newButton.currentTitle = self.currentTitles[i];
            [newButton setTitle:self.currentTitles[i] forState:UIControlStateNormal];
            
            newButton.backgroundColor = colors1[i];
            [buttonsArray2 addObject:newButton];
        }
        
        self.buttons = buttonsArray2;
